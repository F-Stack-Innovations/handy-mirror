...
const DetectePhotoFaceScreen = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.DetectePhotoFaceScreenContainer}>
      {/* CERCLES */}
      ...
      <View style={styles.titleContainer}>
        ...
        <Text style={styles.title}>Prise 1/3</Text>
      </View>

      {/* Options */}
      <View style={styles.faceIDContainer}>
        <Text style={{ color: Tools.color.light.antiquewhite }}>
          Veuillez vous tenir de face devant la caméra
        </Text>
        <Text
          style={{
      ...
      <View style={styles.lastContainer}>
        <Pressable
          style={styles.btn}
          onPress={() => navigation.navigate('DetectePhotoLeftProfileScreen')}
        >
          <Text style={styles.btnText}>Photo de face</Text>
        </Pressable>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  DetectePhotoFaceScreenContainer: {
    flex: 1,
...
export default DetectePhotoFaceScreen;
