  ...
  const updateUserPhotosHandler = async () => {
    try {
      ...
      if (face === '' || left === '' || right === '') {
        ...
        Alert.alert('Oh tu viens de réussir', 'Mise à jour réussi avec succès');
  ...
  return (
    <ScrollView style={styles.DetectePhotoStatusScreenContainer}>
      ...
      <View style={styles.faceIDContainer}>
        ...
        >
          Vous trouverez ci-dessous un ensemble de photo prise qui seront
          analysé par votre miroir afin de vous détecter.
        </Text>
        ...
        <View style={styles.bgcDetection}>
          ...
          >
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate('DetectePhotoFaceScreen')}
            >
              {userData.photos.face ? (
                ...
                <Text style={styles.photoCircleText}>Ajouter votre photo</Text>
              )}
            </TouchableOpacity>
          </View>
          ...
          >
            ...
            <TouchableOpacity
              onPress={() =>
                navigation.navigate('DetectePhotoLeftProfileScreen')
              }
            >
